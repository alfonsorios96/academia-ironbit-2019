...
import {styles} from './contact-list-app-styles.js';
import { fadeInTransitionPage } from './utils/contact-list-app-transitions.js';

import './pages/default-page.js';
import './pages/home-page.js';
import '@polymer/paper-button/paper-button.js';
// import {menuIcon} from './utils/contact-list-app-icons.js';

class ContactListApp extends LitElement {
...
window.customElements.define('contact-list-app-app', ContactListApp);
